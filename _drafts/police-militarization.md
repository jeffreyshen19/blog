...
<div class = "line-chart-normalized" data-csv = "/data/police-militarization/us-population-and-crime.csv" data-xlabel = "Date" data-xcol = "year" data-linecolors = "#3a539b" data-xcolparse = "%Y" data-tooltipformat = "%Y" data-useoffset = "false" data-ycols = '[{"ycol":"population","label":"Population","title": "U.S. Population Over Time"},{"ycol":"violent-crime-rate","label":"Violent Crimes Per 100,000 People","title": "Violent Crime Rate Over Time"}]'  data-id = "3"></div>
