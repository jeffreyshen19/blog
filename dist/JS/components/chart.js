...
let a=d3.select(this.props.chart);this.setState({chart:a})}renderGraph(){console.log(this.state.data)}// renderGraph(){
...
//
// }
render(){return this.state.data.length&&this.state.chart&&this.renderGraph(),null}}